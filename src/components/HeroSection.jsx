  ...
  return (
    <div
      ...
      <img
        src={marvelLogo}
        alt="Background "
        className="max-h-11 lg:max-h-11 mt-20"
      />
      ...
      <button onClick={()=>navigate('/movies')} className='flex items-center gap-1 px-6 py-3 text-sm  bg-red-600 hover:bg-red-500 transition rounded-full font-medium cursor-pointer'>
        Explore Movies 
